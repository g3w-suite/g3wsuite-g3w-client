...
const ol3helpers = require('g3w-ol/index').helpers;
const {getScaleFromResolution, getResolutionFromScale} = require('g3w-ol/utils/utils');
const ControlsFactory = require('gui/components/map/utils/control/factory');
const StreetViewService = require('gui/components/streetview/streetviewservice');
