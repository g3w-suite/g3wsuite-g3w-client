...
const HeaderFormComponent = require('./components/header/header');
const BodyFormComponent = require('./components/body/body');
const G3wFormFooter = require('gui/components/form/components/footer/footer');
